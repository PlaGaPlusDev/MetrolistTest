...
import com.metrolist.innertube.utils.logger
import com.metrolist.innertube.utils.configurePlatformEngine
import com.metrolist.innertube.utils.getDefaultLocale
...
class InnerTube {
    ...
    private fun createClient() = HttpClient {
        ...
        configurePlatformEngine(this@InnerTube.proxy, this@InnerTube.proxyAuth)
    ...
    private suspend fun <T> withRetry(
        ...
        while (true) {
            try {
                ...
                // In KMP, we might want to be more specific or use a multiplatform IO exception
                // For now, catching all exceptions for retry
                attempt++
